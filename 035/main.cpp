...
int main()
{
    ...
    std::cout << "find(root, 110):  Was found? " << std::endl
              << found << convert(ans) << " " << std::endl
              << std::endl;
    ;

    ans = find(&n_0, 80);
    found = (ans != NULL ? "Yes :) In Node    " : "No. ");
    std::cout << "find(root, 80):  Was found? " << std::endl
              << found << convert(ans) << " " << std::endl
              << std::endl;

    ans = find(&n_0, 10);
    found = (ans != NULL ? "Yes :) In Node    " : "No. ");
    std::cout << "find(root, 10):  Was found? " << std::endl
              << found << convert(ans) << " " << std::endl
              << std::endl;

    ans = find(&n_0, 30);
    found = (ans != NULL ? "Yes :) In Node    " : "No. ");
    std::cout << "find(root, 30):  Was found? " << std::endl
              << found << convert(ans) << " " << std::endl
              << std::endl;
